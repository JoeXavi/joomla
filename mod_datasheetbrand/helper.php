...
class ModDatasheetbrandHelper
{
     ...
     */    
        ...
        public static function getBase($params)
        {
            ...
            $db = JFactory::getDbo();
            $datasheets_motorcycles = "select * from #__datasheet_product where marca_id=".$result->marca_id." and state='active' and id<>".$params->get('id')." order by id DESC limit 10";
