...
$document->setMetaData('google-signin-client_id','292053978628-dinmjr4ovqosig46qllndl7p6pahdae3.apps.googleusercontent.com');
...
$document->addScript(JURI::root() .'modules/mod_registerlogin/tmpl/assets/loginGoogle.js');   
...
?>
    ...
    <link href="<?php echo JURI::root() .'modules/mod_registerlogin/tmpl/assets/social.button.css' ?>" type="text/css" rel="stylesheet" />
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4 pb-2">
            <div class="row">
                <div class="col-12 mt-2 p-2">
                    <div class="generalcont jd-clearfix">
                        ...
                        <!--<div class="dnone" id="endRegisterGoogle">
                            <label for="numCel">Solo tu numero celular y listo</label>
                            <input type="number" name="NumCel" size="12" id="numCel" class="jd-form-input required">
                            <button type="submit" class="btn btn-block jd-form-button validate">Registrarse</button>
                        </div>-->  
                    </div>
                    <hr>
                </div>
                        ...
                        <div data-tab id="jd-register-container-<?php echo $module->id; ?>" class="jd-register-container">
                            <?php if ($usersConfig->get('allowUserRegistration')) { ?>
                                <form action="" method="post" id="registration_form" name="josForm" class="form-validate form-horizontal">
                                    ...
                                    <div class="jd-inputbox-control">
                                        <?php if ($params->get('usetext')) : ?><label for=""><?php echo JText::_('COM_USERS_REGISTER_CELLPHONE'); ?> </label>
                                        <?php endif; ?>
                                        <input tabindex="7" placeholder="<?php if(!$params->get('usetext')) { echo JText::_('COM_USERS_REGISTER_CELLPHONE');} ?>" type="number" id="jform_profile_phone" name="jform[profile][phone]" class="jd-form-input required profile_phone"  size="12" required/>
                                    </div>
                                    <div class="jd-inputbox-control">
        ...
        <div class="col-md-8 d-none d-sm-none d-md-block">
            <img src="<?php echo JURI::root() .'modules/mod_registerlogin/tmpl/assets/motero-1-min.png'?>" id="imgregister" />
        </div>
