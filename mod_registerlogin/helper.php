...
{	
	...
	public static function ifloguedinAjax(){
	...
	public static function seeUserLoginAjax(){
		$app = JFactory::getApplication();
		$useremail = str_replace(".arroba","@",$app->input->post->get('user'));
		$password = $app->input->post->get('pass');
		//echo "User:".$useremail." Pass:".$password;
		//exit;
		...
		//echo "User:".$result->username." Pass:".$result->password;
		//exit;
		if ($result)
		{
